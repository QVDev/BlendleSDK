...
public class UserFollowSuggestionsWithLatestPost {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof UserFollowSuggestionsWithLatestPost) == false) {
            return false;
        }
        UserFollowSuggestionsWithLatestPost rhs = ((UserFollowSuggestionsWithLatestPost) other);
