...
public class UserResendConfirmationEmail {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof UserResendConfirmationEmail) == false) {
            return false;
        }
        UserResendConfirmationEmail rhs = ((UserResendConfirmationEmail) other);
